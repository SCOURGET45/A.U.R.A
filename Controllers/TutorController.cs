...
namespace Aura.Controllers
{
    ...
    public class TutorController : Controller
    {
        ...
        public async Task<IActionResult> MisTutorados()
        {
            ...
            {
                new { id = 1, mat = "23301133", nom = "ALAN SANTIAGO MOLINA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 2, mat = "23301145", nom = "MARÍA FERNANDA GÓMEZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 3, mat = "23301199", nom = "CARLOS EDUARDO PÉREZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 4, mat = "23301201", nom = "DANIELA RÍOS CÁRDENAS", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 5, mat = "23301205", nom = "ALBERTO CRUZ ZEPEDA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 6, mat = "23301206", nom = "ALDO ALEXIS MEZA ARGUELLES", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 7, mat = "23301210", nom = "BRIDGED CITLALI CORNEJO YAÑEZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 8, mat = "23301211", nom = "CHRISTOPHER CAMARGO GONZALEZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 9, mat = "23301215", nom = "DELIA LESLIE JIMENEZ NERI", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 10, mat = "23301216", nom = "DIEGO PARRA CRUZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 11, mat = "23301220", nom = "DORIAN ALEJANDRO TREJO VEGA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 12, mat = "23301221", nom = "FATIMA XIMENA GARCIA GONZALEZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 13, mat = "23301225", nom = "FELICITAS RUBI DIEGO GARCIA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 14, mat = "23301230", nom = "JESSUI FLORES PACHECO", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 15, mat = "23301231", nom = "JOSE DE JESUS LOPEZ ISLAS", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 16, mat = "23301235", nom = "LEONARDO ISAAC BARRERA TEJEDA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 17, mat = "23301236", nom = "LIZETH PEREZ ATANACIO", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 18, mat = "23301240", nom = "MARIA DEL ROCIO CRUZ CERVANTES", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 19, mat = "23301241", nom = "MARISOL GONZALEZ VILLA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 20, mat = "23301245", nom = "MELANIE JOLIEE BONILLA DOMINGUEZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 21, mat = "23301246", nom = "OMAR PICAZO ARANZOLO", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 22, mat = "23301250", nom = "OSCAR JOSE SALINAS ESCOBAR", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 23, mat = "23301251", nom = "RODRIGO DOMINGUEZ CRESPO", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 24, mat = "23301255", nom = "RODRIGO SANCHEZ CRUZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 25, mat = "23301256", nom = "VICTOR MANUEL RUFIN PIÑA", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" },
                new { id = 26, mat = "23301260", nom = "YAEL MONROY CRUZ", asis = 100.0, riesg = "Bajo", proc = false, just = 0, dias = 0, dict = "" }
            };
            ...
            foreach (var a in grupoOficial9IDGS)
            {
                if (!tutoradosList.Any(t => t.Matricula == a.mat))
                {
                    ...
                    int justCnt = justMem.Count;
                    int diasCnt = justMem.Sum(j => j.DiasAmparados);
                    bool enProc = solMem != null ? (solMem.Estado == "Pendiente" || solMem.Estado == "Agendado") : false;
                    string dictFinal = solMem != null ? (solMem.Dictamen ?? solMem.Estado) : "";
